...
CP="$TRIE:$NLP:$TARGET:$CONFIG:$NLPCONFIG:$NLPRESOURCE:$OMP_CONFIG:$CLI:$COMMONCLI:$LOG4J:$HNLP:$SPELLER:$CNOUN:$NER"

java -Xmx4G -cp $CP  com.skplanet.nlp.entityExtractor.driver.NLPTester
